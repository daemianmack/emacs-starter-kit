...
(custom-theme-set-faces
 ...
 '(flx-highlight-face ((t (:weight bold :foreground "green" :background "color-234"))))
 ...
 '(ivy-minibuffer-match-face-2 ((t (:foreground "purple"))))
 ...
 '(magit-diff-context ((t (:foreground "gray10"))))
 ...
 '(magit-diff-hunk-heading ((t (:background "blue" :foreground "gray48"))))
 '(magit-diff-hunk-heading-highlight ((t (:background "blue" :foreground "white" :weight bold))))
 ...
 '(magit-section-heading ((t (:background "darkorchid4" :foreground "whitesmoke"))))
 ...
 '(rainbow-delimiters-depth-1-face ((t (:foreground "color-234"))))
 ...
 '(line-number ((t (:foreground "color-234"))))
 ...
 '(org-checkbox ((t (:foreground "color-234"))))
