...
(custom-theme-set-faces
 ...
 '(font-lock-constant-face ((t (:foreground "#0000ee"))))
 '(font-lock-doc-face ((t (:inherit font-lock-string-face))))
 '(font-lock-function-name-face ((t (:background "#000000" :foreground "#5c5cff"))))
 ...
 '(ivy-minibuffer-match-face-1 ((t (:foreground "#a020f0"))))
 '(ivy-minibuffer-match-face-2 ((t (:foreground "#a020f0"))))
 '(ivy-minibuffer-match-face-3 ((t (:background "#0000ff"))))
 '(ivy-minibuffer-match-face-4 ((t (:background "#005f5f"))))
 ...
 '(magit-branch-local ((t (:foreground "#0000ee"))))
 '(magit-branch-remote ((t (:background "#000000" :foreground "#0000ee"))))
 ...
 '(magit-diff-hunk-heading ((t (:background "#0000ee" :foreground "#7a7a7a"))))
 '(magit-diff-hunk-heading-highlight ((t (:background "#0000ee" :foreground "#e5e5e5" :weight bold))))
 '(magit-diff-hunk-heading-selection ((t (:foreground "#0000ee"))))
 ...
 '(neo-file-link-face ((t (:foreground "#e5e5e5"))))
 ...
 '(tab-bar-tab-inactive ((t (:background "#000000" :foreground "#0087ff"))))
