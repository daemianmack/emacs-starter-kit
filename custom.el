...
(custom-set-faces
 ...
 '(magit-diff-add ((t (:inherit diff-added :foreground "green4"))))
 '(magit-diff-del ((t (:inherit diff-removed :foreground "red3"))))
 '(magit-diff-file-header ((t (:background "bright blue" :weight bold))))
 '(magit-diff-hunk-header ((t (:background "black" :foreground "bright blue" :weight bold))))
