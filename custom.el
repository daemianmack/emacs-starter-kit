...
(custom-set-faces
 ...
 '(hi-black-b ((t (:foreground "black"))) t)
 '(hi-black-hb ((t (:background "black" :foreground "brightblack"))) t)
 '(hi-blue ((t (:background "blue1" :foreground "black"))) t)
 '(hi-green ((t (:background "green1" :foreground "black"))) t)
 '(hi-pink ((t (:background "color-165" :foreground "black"))) t)
 '(hi-yellow ((t (:background "yellow1" :foreground "black"))) t)
