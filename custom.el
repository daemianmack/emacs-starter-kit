...
(custom-set-faces
 ...
 '(isearch-lazy-highlight-face ((t (:background "blue" :foreground "black" :underline "white" :weight bold))) t)
 '(italic ((((supports :underline t)) (:underline nil))))
 '(lazy-highlight ((((class color) (min-colors 88) (background light)) (:background "blue" :foreground "black" :underline "white" :weight bold))))
 ...
 '(modeline ((t (:background "blue" :foreground "blue" :box (:line-width -1 :style released-button)))) t)
